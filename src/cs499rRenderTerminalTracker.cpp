...
namespace CS499R
{
    ...
    {
        mRayCount = ctx->renderTargetResolution.x * ctx->renderTargetResolution.y * ctx->pixelRayCount();

        std::cout << "Input:" << std::endl;
        std::cout << "    Render width:             " << ctx->renderTargetResolution.x << " px" << std::endl;
        std::cout << "    Render height:            " << ctx->renderTargetResolution.y << " px" << std::endl;
